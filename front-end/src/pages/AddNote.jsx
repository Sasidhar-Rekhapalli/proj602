    ...
    return(
        <div className="container">
            ...
            <Card className="m-3">
                ...
                <nav className="navbar navbar-expand-lg" style={{"background-color":"#f1f1f1"}}>
                <div class="collapse navbar-collapse" id="basicExampleNav">
                    <ul class="navbar-nav mr-auto" >
                        <li class="nav-item active" >
                            <a class="nav-link" href="#" style={{"color":"black"}}>Note</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#" style={{"color":"black"}}>File in share folder</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#" style={{"color":"black"}}>Uploaded File</a>
                        </li>
                    </ul>
                </div>
                </nav>
                <Link to="/student" style={{"display":'inline-block'}}>
                <Button className="btn btn-primary m-3 col-md-2" style={{ float: "right" }}>
                    Update
                </Button>
                </Link>

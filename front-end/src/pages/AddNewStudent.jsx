              ...
              <Card className="mx-auto container" >
                ...
                <Form>
                  <Form.Group className="row mb-3">
                    ...
                    <div className=" col">
                      <Form.Check label="Prospective Student" onChange={this.handleProspectiveStudent}  />
                    </div>
                    {/* Student ID label with input  */}
                    <Form.Label className="col-sm-2" style={{ textAlign: "right" }}>Student ID:</Form.Label>
                    <Form.Control className="col pt-0" onChange={this.handleValidatedStudentID}></Form.Control>
                  </Form.Group>
                  {/* First and Last name with input and label  */}
                  <Form.Group>
                    <div className="row mb-3">
                    <Form.Label className="col-md-2">First name:</Form.Label>
                    <Form.Control className="col" onChange={this.handleValidatedFirstName}></Form.Control>
                    <Form.Label className="col-md-2">Middle Name:</Form.Label>
                    <Form.Control className="col" onChange={this.handleValidatedMiddleName}></Form.Control>
                    <Form.Label className="col-md-2">Last name:</Form.Label>
                    <Form.Control className="col" onChange={this.handleValidatedLastName}></Form.Control>
                    </div>
                    {/* Check box for Gender  */}
                    <div className="row mb-3">
                    <Form.Label className="col-lg-2">Gender:</Form.Label>
                      <div className="form-check col-lg-1">
                        <input className="form-check-input col" type="radio" onChange={this.handleGenderMale} name="flexRadioDefault" id="flexRadioDefault1"/>
                        <label className="form-check-label col">Male</label>
                      </div>
                      <div className="form-check col-lg-1">
                        <input className="form-check-input col" type="radio" onChange={this.handleGenderFemale} name="flexRadioDefault" id="flexRadioDefault2"/>
                        <label className="form-check-label col">Female</label>
                      </div>
                      <div className="form-check col-lg-1">
                        <input className="form-check-input col" type="radio" onChange={this.handleGenderNone} name="flexRadioDefault" id="flexRadioDefault2"/>
                        <label className="form-check-label col">None</label>
                      </div>
                      {/* Date of Birth with input and label  */}
                      <Form.Label className="col-lg-2" style={{ textAlign: "right" }}>Birth Date:</Form.Label>
                      <Form.Control type="date" className="col pt-0" onChange={this.handleValidatedDayOfBirth} ></Form.Control>
                    </div>
                    {/* Country input and label  */}
                    <div className="row mb-3">
                      <Form.Label className="col-md-2">Country:</Form.Label>
                      <Form.Select className="col" onChange={this.handleValidatedCountry}>
                      ...
                      <Form.Control className="col" onChange={this.handleValidatedEmail}></Form.Control>
                    </div>
                    ...
                    <div className="row mb-3">
                      ...
                      <Form.Select className="col" onChange={this.handleValidatedPeriod}>
                        <option>-- Select Period --</option>
                        <option value="Spring Semester 2022/2023">Spring Semester 2022/2023</option>
                        <option value="Summer Semester 2022/2023">Summer Semester 2022/2023</option>
                        <option value="Fall Semester 2022/2023">Fall Semester 2022/2023</option>
                        <option value="Winter Semester 2022/2023">Winter Semester 2022/2023</option>
                        <option value="Spring Semester 2021/2022">Spring Semester 2021/2022</option>
                        <option value="Summer Semester 2021/2022">Summer Semester 2021/2022</option>
                        <option value="Fall Semester 2021/2022">Fall Semester 2021/2022</option>
                        <option value="Winter Semester 2021/2022">Winter Semester 2021/2022</option>
                      </Form.Select>
                    </div>
                    {/* Year and Program with label and input  */}
                    <div className="row mb-3">
                      <Form.Label className="col-md-2">Year:</Form.Label>
                      <Form.Select className="col" onChange={this.handleValidatedYear}>
                      ...
                      <Form.Select className="col" onChange={this.handleValidatedProgram}>
                        <option>-- Select Program --</option>
                        <option value="Business">Business</option>
                        <option value="Civil Engineering Technologies">Civil Engineering Technologies</option>
                    ...
                    <div className="row">
                      ...
                      <Form.Select className="col" onChange={this.handleValidatedDegree}>
                      ...
                      <Form.Label className="col" style={{ textAlign: "right" }}>Graduate Ind:</Form.Label>
                      <Form.Select className="col" onChange={this.handleValidatedGraduate}>
                        <option>-- Select Option --</option>
                        <option value="Y">Yes</option>
                        <option value="N">No</option>
                      </Form.Select>
                      {/* Enroll with label and input  */}
                      <Form.Label className="col" style={{ textAlign: "right" }}>Enroll:</Form.Label>
                      <Form.Select className="col" onChange={this.handleValidatedEnroll}>
                        <option>-- Select Option --</option>
